package com.sipakal.ocbanking.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("OpenCoreBankingV1");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("OpenCoreBankingV1");
        ...
        config.getMapConfigs().put("com.sipakal.ocbanking.domain.*", initializeDomainMapConfig(jHipsterProperties));
